...
(function () {
  ...
  // SQL syntax highlighting — shared with Result Panel via SQL_HIGHLIGHT_SCRIPT
  // injected into the webview HTML. Both panels consume window.ViewstorSql.highlightSql.
