...
(function () {
  ...
  // ---- Cell selection + copy ----
  // Delegated to the shared ViewstorDataGrid module (#94).
  ...
  window.ViewstorDataGrid.createSelectionManager({
    cellSelector: '.diff-table tbody td, .diff-schema-table tbody td',
    tableSelector: '.diff-table, .diff-schema-table',
