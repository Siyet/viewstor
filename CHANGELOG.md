...
### Added
- **MongoDB driver** — connect to MongoDB instances, browse databases and collections, execute shell-like commands (`db.collection.find/aggregate/insert/update/delete`), view collection statistics and indexes, auto-detect field types by sampling documents. Supports authentication database, SSL, and connection strings ([#10](https://github.com/Siyet/viewstor/issues/10))
