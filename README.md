...
<p align="center">
  <b>PostgreSQL + Redis + ClickHouse + SQLite + Kafka in one extension.<br>Free. Open source. No paywalls.</b>
</p>
...
Viewstor is a free, open-source extension that covers PostgreSQL, Redis, ClickHouse, SQLite, and Apache Kafka in a single tool — with features you won't find elsewhere:
...
| **PG + Redis + CH + SQLite + Kafka** | All free | Free tier limits | No Redis / no Kafka | Redis/CH paid |
...
| Apache Kafka | TCP | [kafkajs](https://www.npmjs.com/package/kafkajs) |
